...
#ifndef ADROPADS_SWIFT_H
#define ADROPADS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdropAds",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic) BOOL useCustomClick;
/// 현재 배너 WKWebView가 사용 중인 WebContent 프로세스 PID.
/// 0이면 조회 실패 또는 지원되지 않음. 프로세스 재기동/모니터링 용도.
/// warning:
/// <code>_webProcessIdentifier</code>는 WebKit <em>비공개 API</em>다. KVC 문자열이
/// 릴리즈 바이너리에 포함되면 App Store 심사에서 리젝될 수 있으므로 <em>DEBUG
/// 빌드에서만 컴파일</em>한다 (릴리즈 바이너리에는 이 코드·문자열이 들어가지 않음).
@property (nonatomic, readonly) int32_t webContentProcessIdentifier;
...
@class WKNavigation;
@interface AdropBanner (SWIFT_EXTENSION(AdropAds)) <WKNavigationDelegate, WKUIDelegate>
...
- (void)onAdDidPresentFullScreen:(AdropInterstitialAd * _Nonnull)ad;
...
SWIFT_PROTOCOL("_TtP8AdropAds21AdropNativeAdDelegate_")
@protocol AdropNativeAdDelegate
...
@interface AdropNativeAdView : UIView
...
@property (nonatomic, copy) void (^ _Nullable onAdReceived)(AdropPopupAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable onAdFailedToReceive)(AdropPopupAd * _Nonnull, enum AdropErrorCode);
@property (nonatomic, copy) void (^ _Nullable onAdImpression)(AdropPopupAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable onAdClicked)(AdropPopupAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable onAdWillPresentFullScreen)(AdropPopupAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable onAdDidPresentFullScreen)(AdropPopupAd * _Nonnull);
...
@property (nonatomic, strong) UIColor * _Nullable ctaTextColor;
- (nonnull instancetype)initWithUnitId:(NSString * _Nonnull)unitId OBJC_DESIGNATED_INITIALIZER;
- (void)load;
- (void)showFromRootViewController:(UIViewController * _Nonnull)fromRootViewController;
- (void)open:(NSString * _Nullable)url useInAppBrowser:(BOOL)useInAppBrowser;
...
- (void)onAdDidPresentFullScreen:(AdropRewardedAd * _Nonnull)ad;
...
@property (nonatomic, copy) void (^ _Nullable onAdReceived)(AdropSplashAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable onAdFailedToReceive)(AdropSplashAd * _Nonnull, enum AdropErrorCode);
@property (nonatomic, copy) void (^ _Nullable onAdImpression)(AdropSplashAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nullable onAdClose)(AdropSplashAd * _Nonnull, BOOL);
@property (nonatomic, readonly, copy) NSString * _Nonnull txId;
@property (nonatomic, readonly, copy) NSString * _Nonnull campaignId;
@property (nonatomic, readonly, copy) NSString * _Nonnull unitId;
@property (nonatomic, readonly, copy) NSString * _Nonnull destinationURL;
...
@property (nonatomic, readonly, strong) UIImage * _Nullable adImage;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
